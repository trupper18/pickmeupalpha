	 ...
	 <div align='center'>
          <ul class='navbar'>
             ...
             <li><a href='sports.php'>Sports</a>
                <ul>
                    <li><a href='mainPage.php'>All Categories</a></li>
			 ...
			 $query = ("SELECT * FROM posts WHERE post_cat='Activities' ORDER by post_id DESC"); // Queries the Database to check if the user doesn't exist
